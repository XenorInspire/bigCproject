...
// gcc -o blindtestGUI.exe blindtestGUI.o gui.o xml.o verify.o manage_song.o generate.o init.o settings.o game.o `pkg-config --libs gtk+-3.0` ../lib/fmod/libfmodex.a
